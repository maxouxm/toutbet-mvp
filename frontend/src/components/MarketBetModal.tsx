        ...
        <div className="px-6 pb-6">
          ...
          <div className="mt-5">
            ...
            <div className="mt-3 text-xs text-white/50">
              Min: {money(minEur)} · Pool: {money(totalPool)} · {participants} participants
            </div>
          </div>
          ...
          <div className="mt-6 rounded-2xl border border-accent/60 bg-accent/10 p-4">
            ...
            {!estimate ? (
              ...
              <div className="mt-3 grid gap-2 sm:grid-cols-3 tb-pop">
                ...
                <div className="rounded-2xl border border-white/10 bg-black/20 p-3">
                  <div className="text-xs text-white/60">Ton choix</div>
                  <div className="text-lg font-extrabold text-white">{side === 'yes' ? 'OUI' : 'NON'}</div>
                </div>
                <div className="sm:col-span-3 text-xs text-white/50">
                  Estimation basée sur les pools actuels (après ajout de ta mise). Le payout réel dépend des mises finales.
                </div>
              </div>
            )}
          </div>
